...
// joint pvt control with delta position limit  // 带有位置增量限制的pvt控制 目的是防止关节过冲
...
// Enable PV control item for all joints. Note the PV control item is default enabled, no need for
